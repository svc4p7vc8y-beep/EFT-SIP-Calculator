...
function FloorPlan({ house }) {
  return <figure className="floor-plan"><svg viewBox="0 0 620 500" role="img" aria-label={`Пример зонирования дома ${house.name}`}>
    ...
    <g fill="#344238" fontSize="14" textAnchor="middle" fontFamily="Arial, sans-serif"><text x="135" y="194">{house.rooms[1]}</text><text x="485" y="196">{house.rooms[2]}</text><text x="314" y="290">{house.rooms[0]}</text><text x="132" y="355">{house.rooms[3]}</text><text x="487" y="355">{house.rooms[4]}</text></g>
