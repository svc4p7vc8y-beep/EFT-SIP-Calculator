          ...
          >
            ...
            {calculation.sip.consumables.mode === "node" ? (
              <p className="panel-note">
                ...
                пересчитывает ведомость и смету. Саморезы 6×120 применяются
                только в Т-образных узлах SIP-перегородок; для каркасных
                перегородок или при отсутствии таких узлов значение 0 шт
                корректно.
              </p>
            ) : null}
          </Panel>
