...
export function calculationFlowRows(project, calculation) {
  ...
  return [
    ...
    { group: 'СИП', source: 'Нижняя/верхняя обвязка и вертикальные углы', formula: `обвязка с шагом ${f.sipBindingScrewSpacingM} м + углы с шагом ${f.sipCornerScrewSpacingM} м`, result: calculation.sip.consumables.totals.structuralCount, unit: 'шт', target: 'Конструкционные саморезы 8×180 / 8×220 / 8×280' },
