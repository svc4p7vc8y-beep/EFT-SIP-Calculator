...
export function calculationFlowRows(project, calculation) {
  ...
  return [
    ...
    { group: 'Кровля', source: 'Линия конька', formula: `длина конька × ${f.ridgeBeamReserve}`, result: calculation.roof.ridgeBeamPurchaseLength, unit: 'м.п.', target: `Стропильная доска ${project.settings.roof.rafterSection === '50x200' ? '50×200' : '50×150'} (коньковый прогон)` },
    { group: 'Кровля', source: 'Карнизы и торцы скатов', formula: `карнизы 2L; торцы 4 × длина ската; запас ${f.roofTrimReserve}`, result: calculation.roof.mainEaveTrimPurchaseLength + calculation.roof.mainVergeTrimPurchaseLength, unit: 'м.п.', target: 'Карнизные и ветровые планки с монтажом' },
