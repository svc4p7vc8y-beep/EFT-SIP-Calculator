...
export function calculationFlowRows(project, calculation) {
  ...
  return [
    ...
    { group: 'СИП', source: 'Т-образные узлы SIP-перегородок', formula: `${f.sipUniversalScrewsPerTNode} самореза на узел`, result: calculation.sip.consumables.totals.universalScrewCount, unit: 'шт', target: 'Саморезы 6×120' },
