...
export function calculationFlowRows(project, calculation) {
  ...
  return [
    ...
    { group: 'Кровля', source: 'Линия конька', formula: `длина конька × ${f.ridgeBeamReserve}`, result: calculation.roof.ridgeBeamPurchaseLength, unit: 'м.п.', target: 'Коньковый прогон 100×150 и монтаж' },
